...
pub async fn create_tables(pool: &sqlx::PgPool, drop: bool) -> Result<(), sqlx::Error> {
    ...
    sqlx::query!(r#"CREATE INDEX IF NOT EXISTS idx_doctor_id ON doctors(id);"#)
        .execute(pool)
        .await?;
    ...
    sqlx::query!(r#"CREATE INDEX IF NOT EXISTS idx_pharmacist_id ON pharmacists(id);"#)
        .execute(pool)
        .await?;
    ...
    sqlx::query!(r#"CREATE INDEX IF NOT EXISTS idx_prescription_id ON prescriptions(id);"#,)
        .execute(pool)
        .await?;
    ...
    sqlx::query!(r#"CREATE INDEX IF NOT EXISTS idx_drug_id ON drugs(id);"#)
        .execute(pool)
        .await?;
    ...
    sqlx::query!(r#"CREATE INDEX IF NOT EXISTS idx_prescribed_drug_id ON prescribed_drugs(id);"#)
        .execute(pool)
        .await?;
    ...
    sqlx::query!(
        r#"CREATE INDEX IF NOT EXISTS idx_prescription_fill_id ON prescription_fills(id);"#
    )
    .execute(pool)
    .await?;

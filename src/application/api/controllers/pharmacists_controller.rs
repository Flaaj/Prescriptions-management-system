...
mod tests {
    ...
    use crate::{
        context::setup_context, domain::pharmacists::entities::Pharmacist,
    ...
    #[sqlx::test]
    async fn create_pharmacist_returns_conflict_if_pesel_number_is_duplicated(pool: sqlx::PgPool) {
        let client = create_api_client(pool).await;
